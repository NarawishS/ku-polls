...
class QuestionModelTests(TestCase):
    """Test case for Question class in models."""
...
def create_question(question_text, days):
    """Create Question with the given text and day.
    ...
    :param
        question_text(str): text of this question
        days(int): period of this question
    """
...
class QuestionDetailViewTests(TestCase):
    """Test case for detail of Question."""
